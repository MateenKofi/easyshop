  ...
  return (
    <div className="flex items-center font-semibold z-20">
      {isAuthenticated ? (
        <>
          <button className="w-full relative">
            <div
              ...
              className="flex flex-col rounded-2xl items-center bad  xl:px-4 px-2 text-sm xl:text-base"
            >
            ...
            <ul
              className={`${
                dropDown ? "block w-full mt-10 px-10" : "hidden"
        ...
        <>
          <Link
            className="text-sm md:text-base xl:text-lg mx-2 flex items-center px-2 border border-blue-500 dark:border-grayshade-300  text-blue-500 dark:text-grayshade-300 rounded-xl"
            to="/auth/login"
          >
