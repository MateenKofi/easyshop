...
function Header() {
  ...
  return (
    <nav
      ...
      }  z-[100] xl:relative py-4 px-1 md:px-14 lg:px-30 w-full bg-lightColor-100 dark:bg-grayshade-500`}
    >
      <div
      ...
      <div className="w-full flex items-center justify-end min-[490px]:justify-around">
        <Link
          className="lg:text-3xl md:text-4xl sm:text-xl font-extrabold xl:mr-8 z-20"
          to={"/"}
        >
          <h1>EasyShop</h1>
        </Link>
        <div
          ...
          } xl:block bg-lightColor-100 dark:bg-grayshade-500 xl:px-8 flex flex-col items-center justify-center h-screen top-0 left-0 fixed xl:h-min xl:[position:initial]`}
        >
          <ul className="flex flex-col items-center xl:flex-row min-w-max w-screen xl:w-[400px] xl:justify-around text-xl">
            <li className="my-5 xl:my-2 hover:border-b-2 hover:border-orange-400 transition-all duration-200">
              <Link to="/home" onClick={() => openNavOpen(false)}>
                Home
              </Link>
            </li>
            <li className="my-5 xl:my-2  hover:border-b-2 hover:border-orange-400 transition-all duration-200">
