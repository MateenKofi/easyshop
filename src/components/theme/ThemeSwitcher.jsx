...
function ThemeSwitcher() {
  ...
  const [theme, setTheme] = useState(themes.find((i) => i.mode === "light")); // Set default theme to light
  const ref = useRef();
  useEffect(() => {
    ...
    if (!localStorage.theme) {
      localStorage.theme = "light"; // Set default theme in local storage to light
    }
